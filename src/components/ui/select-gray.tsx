...
function SelectTrigger({
  ...
  const variantClasses = {
    ...
    input:
      "bg-Neutral-BG-1 hover:bg-Neutral-BG-2 text-sm/[20px] flex justify-start w-full h-11 py-3 px-4",
  };
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        "data-[placeholder]:text-Neutral-BG-4 [&_svg:not([class*='text-'])]:text-muted-foreground",
        " focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40",
        "aria-invalid:border-destructive dark:bg-input/30 dark:hover:bg-input/50 flex w-full items-center justify-between gap-2 rounded-md px-3 py-2",
