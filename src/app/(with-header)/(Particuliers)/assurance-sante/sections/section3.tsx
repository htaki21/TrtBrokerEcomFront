...
const cardsData = [
  ...
  },
  {
    ...
    description: "Pensé pour les besoins globaux, sans compromis.",
    ceiling: {
      amount: "10 000 000",
      currency: "Dh / an",
    },
    features: [
      "Soins au Maroc & à l’étranger",
      "Séjours hospitaliers prolongés",
      "Chirurgies, oncologie, maternité",
...
const FeatureCard: React.FC<CardProps> = ({
  ...
  return (
    <div className="f-col flex-1 ">
      <div className="f-col p-5 max-mobile:p-4 gap-9 max-mobile:gap-5 rounded-2xl bg-white shadow-lg">
        ...
        <ul
          className="flex items-center gap-10
                max-mobile:flex-col max-mobile:items-start max-mobile:gap-4"
        >
          {reimbursement && (
            <li>
